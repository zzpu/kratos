...
`internal/service`内的`Service`结构实现了`DemoServer`接口可参考[kratos-demo内的service](https://github.com/zzpu/kratos-demo/blob/master/internal/service/service.go)内的如下代码：
