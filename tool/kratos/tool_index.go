...
var toolIndexs = []*Tool{
	{
		...
		Install:   "go get -u github.com/zzpu/kratos/tool/kratos",
		Summary:   "Kratos工具集本体",
	...
	},
	{
		...
		Install:   "go get -u github.com/zzpu/kratos/tool/kratos-protoc",
	...
	},
	{
		...
		BuildTime: time.Date(2019, 10, 31, 0, 0, 0, 0, time.Local),
		Install:   "go get -u github.com/zzpu/kratos/tool/kratos-gen-bts",
		Summary:   "缓存回源逻辑代码生成器",
		Platform:  []string{"darwin", "linux", "windows"},
		Author:    "kratos",
	},
	{
		...
		Install:   "go get -u github.com/zzpu/kratos/tool/kratos-gen-mc",
		Summary:   "mc缓存代码生成",
		Platform:  []string{"darwin", "linux", "windows"},
		Author:    "kratos",
	},
	...
	},
	{
		...
		Install:      "go get -u github.com/zzpu/kratos/tool/kratos-gen-project",
	...
	},
	{
		...
		Install:   "go get -u github.com/zzpu/kratos/tool/testcli",
		Summary:   "测试代码生成",
		Platform:  []string{"darwin", "linux", "windows"},
		Author:    "kratos",
	},
